...
/*extra credit prints out the name depending on the parameter passed*/
void extra_credit(food current_food){
    char* foodStrings[] = {"pizza", "soda", "bread"};
    
    printf("%s\n", foodStrings[current_food]);
}